...
public class CacheTacticGrammaireTokenManager implements CacheTacticGrammaireConstants {
...
"\103\101\114\114\105\105\72", "\115\105\124\110\117\104\72", "\54", "\73", };
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public CacheTacticGrammaireTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public CacheTacticGrammaireTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
